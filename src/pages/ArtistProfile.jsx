...
export default function ArtistProfile() {
  ...
  const priceLabel = (w) =>
    w.customizable
      ? w.price_per_unit
        ? `From ${formatPrice(w.price_per_unit)}/${w.unit || "unit"}²`
        : "Made to size"
      : w.price > 0
        ? formatPrice(w.price)
        : "Enquire";
  ...
  return (
    <section
      style={{ padding: "100px 24px 60px", maxWidth: 1200, margin: "0 auto" }}>
      {/* hero */}
      <div
        style={{
          display: "grid",
            ...
            <motion.div
              ...
              <div
                style={{
                  ...
                  marginTop: 6,
                  color:
                    w.in_stock === false ? "rgba(200,191,160,0.5)" : "#D4AF37",
                }}>
