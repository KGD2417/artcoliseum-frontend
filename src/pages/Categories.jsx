...
const CATEGORIES = [
  { slug: 'paintings',   name: 'Paintings',   description: 'Oil, Acrylic & Watercolor masterpieces', count: '2,400+ works',
    img: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=900&q=80&auto=format&fit=crop' },
  { slug: 'sculptures',  name: 'Sculptures',  description: 'Bronze, Marble & Mixed Media',           count: '840+ works',
    img: 'https://images.unsplash.com/photo-1554907984-15263bfd63bd?w=900&q=80&auto=format&fit=crop' },
  { slug: 'photography', name: 'Photography', description: 'Fine Art & Documentary',                 count: '1,200+ works',
    img: 'https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=900&q=80&auto=format&fit=crop' },
  { slug: 'digital',     name: 'Digital',     description: 'NFT & Generative Canvas',                count: '3,600+ works',
    img: 'https://images.unsplash.com/photo-1633437039415-f3d6611db4d5?w=900&q=80&auto=format&fit=crop' },
  { slug: 'drawings',    name: 'Drawings',    description: 'Charcoal, Pastel & Ink',                 count: '950+ works',
    img: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=900&q=80&auto=format&fit=crop' },
  { slug: 'prints',      name: 'Prints',      description: 'Limited Edition Fine Art Prints',         count: '2,100+ works',
...
export default function Categories() {
  ...
  return (
    <section style={{ padding: '120px 32px 100px', maxWidth: 1280, margin: '0 auto' }}>
      <motion.div
        ...
        <p style={{ fontFamily: "'Raleway',sans-serif", fontSize: 14, color: 'rgba(200,191,160,0.6)', maxWidth: 540, margin: '14px auto 0', lineHeight: 1.7 }}>
        ...
        {visible.map((cat, i) => (
          <motion.div
            ...
            <div style={{
              ...
              background: 'linear-gradient(to top, rgba(8,8,8,0.92) 0%, rgba(8,8,8,0.35) 50%, rgba(8,8,8,0.05) 100%)',
              pointerEvents: 'none',
            }} />
            <div style={{ position: 'absolute', bottom: 24, left: 24, right: 24 }}>
              <h3 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 28, fontWeight: 700, color: '#fff', letterSpacing: '0.02em', marginBottom: 6 }}>
                {cat.name}
              </h3>
              <p style={{ fontFamily: "'Raleway',sans-serif", fontSize: 12, color: 'rgba(220,210,190,0.75)', marginBottom: 10 }}>
                {cat.description}
              </p>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span className="num-value" style={{ fontFamily: "'Raleway',sans-serif", fontSize: 11, color: '#D4AF37', letterSpacing: '0.08em' }}>
                  {cat.count}
                </span>
                <span style={{ fontFamily: "'Cinzel',serif", fontSize: 10, letterSpacing: '0.18em', color: '#D4AF37' }}>
                  EXPLORE →
                </span>
              </div>
            </div>
