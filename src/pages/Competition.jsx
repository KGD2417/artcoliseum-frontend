...
const RULES = [
  [
    "Original work",
    "Each entry must be your own original, unpublished artwork. Plagiarised or AI-generated-only work is disqualified.",
  ],
  [
    "One entry",
    "One entry per artist per competition. The most recent submission stands.",
  ],
  [
    "Submission",
    "Provide a title, a short narrative and at least one clear, high-resolution image (video optional).",
  ],
  [
    "Judging",
    "An external jury rates each entry on the competition day. The highest average score wins.",
  ],
  [
    "Prize",
    "The winner is celebrated across Art Coliseum and promoted to a verified selling artist.",
  ],
  [
    "Conduct",
    "Entries must be appropriate for public display. The jury's decision is final.",
  ],
];
...
export default function Competition() {
  ...
  return (
    <div
      style={{ background: "#080808", minHeight: "100vh", paddingBottom: 100 }}>
      {/* Heading (matches the site-wide section heading style) */}
      <PageHeading
        eyebrow="The Art Coliseum Competition"
        title={
          liveComp
            ? liveComp.title
            : openComp
        ...
        subtitle="Showcase your talent through prestigious juried competitions evaluated by distinguished artists, curators, and industry experts."
      />
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 32px 0" }}>
        ...
        {liveComp && (
          <section style={{ marginBottom: 56 }}>
            <SectionRule
              label="LIVE — ENTRIES BEING JUDGED"
                  ...
                  <motion.div
                    ...
                    <div style={{ marginTop: 12 }}>
                      ...
                      <div
                        ...
                        {(e.artist_name || "ARTIST").toUpperCase()}
        ...
        {openComp && (
          <section style={{ marginBottom: 56 }}>
            <SectionRule
              ...
              right={
                openComp.event_date
                  ? new Date(openComp.event_date).toLocaleDateString()
                  : ""
              }
            />
            <Rules />
            {user ? (
              ...
              <div style={{ textAlign: "center", padding: "28px 0" }}>
                ...
                <button onClick={() => navigate("/signin")} style={btn}>
                  SIGN IN TO ENTER →
                </button>
              </div>
            )}
              ...
              <div
                ...
                <span
                  style={{
                    ...
                    color: m.status === "winner" ? "#4ade80" : gold,
                  }}>
        ...
        {!liveComp && !openComp && (
          <div style={{ textAlign: "center", padding: "40px 24px 0" }}>
            <p
              ...
              No competition is open right now. Our next juried competition will
              be announced soon — meanwhile, you can join as an artist any time.
            </p>
            <Link
              to="/become-artist"
              style={{
...
function EntryForm({ comp, onSubmitted }) {
  ...
  const submit = async () => {
    if (comp.status !== "open")
      return alert("This competition is not accepting entries right now.");
    ...
    setBusy(true);
    try {
      await api.competitions.submitEntry(comp.id, {
        ...entry,
        image_urls: images,
        video_url: video,
      });
    ...
    <div
      ...
      {done && (
        <div
          ...
          ✓ Entry submitted! It appears in the live gallery on the competition
          day.
        </div>
      )}
      <label
...
function SectionRule({ label: l, right }) {
  return (
    <div
      ...
      <div
        style={{ width: 32, height: 1, background: "rgba(212,175,55,0.4)" }}
      />
      <span
        style={{
          fontFamily: "'Cinzel',serif",
      ...
      <div
        style={{ flex: 1, height: 1, background: "rgba(212,175,55,0.15)" }}
      />
      {right && (
        <span
          style={{
