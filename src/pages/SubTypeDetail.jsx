...
const SUBTYPE_DATA = {
  paintings: {
    ...
    watercolor: {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1547826039-bfc35e0f1ea8?w=1600&q=80",
      origin: [
    ...
    fresco: {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1567359781514-3b964e2b04d6?w=1600&q=80",
      origin: [
  ...
  sculptures: {
    ...
    kinetic: {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1577720580479-7d839d829c73?w=1600&q=80",
      origin: [
  ...
  photography: {
    ...
    documentary: {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1517816743773-6e0fd518b4a6?w=1600&q=80",
      origin: [
    ...
    abstract: {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1502691876148-a84978e59af8?w=1600&q=80",
      origin: [
  ...
  digital: {
    ...
    "ar-ready": {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1633437039415-f3d6611db4d5?w=1600&q=80",
      origin: [
    ...
    "ai-assisted": {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1614680376573-df3480f0c6ff?w=1600&q=80",
      origin: [
  ...
  drawings: {
    charcoal: {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1520420097861-e4959843b682?w=1600&q=80",
      origin: [
  ...
  prints: {
    ...
    etching: {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1586941962765-d3896cc85ac6?w=1600&q=80",
      origin: [
    ...
    screen: {
      ...
      heroImg:
        "https://images.unsplash.com/photo-1486162928267-e6274cb3106f?w=1600&q=80",
      origin: [
...
export default function SubTypeDetail() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        if (!cancelled)
          setMeta({
            label: fallback?.label || titleCase(sub),
            mediumLabel: titleCase(medium),
          });
      }
      ...
      try {
        ...
        if (sub === "all") {
          ...
          if (!rows || rows.length === 0) {
            ...
            rows = (all || []).filter(
              (a) =>
                (a.subtype_id || "").toLowerCase() === sublc ||
                (a.style || "").toLowerCase() === sublc,
            );
          }
        }
        if (!cancelled) {
  ...
  const heroSub =
    fallback?.sublabel ||
    `${meta?.mediumLabel || titleCase(medium)} collection`;
  const heroImg =
    meta?.image ||
    items[0]?.img ||
    fallback?.heroImg ||
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <Link
              to={`/categories/${medium}`}
              style={{
                color: "rgba(200,191,160,0.5)",
                textDecoration: "none",
              }}>
              {meta?.mediumLabel || titleCase(medium)}
            </Link>
            <span style={{ color: "rgba(212,175,55,0.4)" }}>›</span>
        ...
        <div style={{ marginTop: 72 }}>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  color:
                    collectionTab === key ? "#111" : "rgba(200,191,160,0.55)",
                ...
                <motion.div
                      ...
                      {hoveredId === item.id && (
                        <motion.div
                          ...
                          style={{
                            ...
                            width: "54%",
                            background:
                              "linear-gradient(to left, rgba(8,8,8,0.96) 55%, rgba(8,8,8,0.72) 100%)",
                  ...
                  <label
                    ...
                    style={{
                      ...
                      fontSize: 9,
                      letterSpacing: "0.14em",
                      color: compareIds.includes(item.id)
                        ? "#D4AF37"
                        : "rgba(200,191,160,0.5)",
                    }}>
                    <input
                      type="checkbox"
          ...
          {!loading && galleryItems.length === 0 && (
            <div
              ...
              No{" "}
              {collectionTab === "predefined"
                ? "ready-to-buy"
                : "made-to-order"}{" "}
              works in this collection yet.
            </div>
          )}
          {galleryItems.length > 0 && (
            <div
              ...
              <div
                ...
                SHOWING {galleryItems.length} WORK
